...
private fun Layout(
    ...
    Column(
        ...
        //dark mode
        val darkTheme = resolver.darkUiMode
        DropDownPreference(
        ...
        //force accent
        val forceAccent = resolver.forceAccent
        SwitchPreference(
        ...
        //color status bar
        val colorStatusBar = resolver.colorStatusBar
        SwitchPreference(
        ...
        //hide status bar
        val hideStatusBar = resolver.hideStatusBar
        SwitchPreference(
