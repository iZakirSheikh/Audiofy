...
object DateUtils {
    ...
    @Deprecated("find new solution.")
    fun formatAsRelativeTimeSpan(mills: Long) = DateUtils.getRelativeTimeSpanString(
        mills, System.currentTimeMillis(), DateUtils.DAY_IN_MILLIS, DateUtils.FORMAT_ABBREV_RELATIVE
    ) as String
