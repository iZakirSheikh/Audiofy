...
import com.zs.feature.widget.common.Chronometer
import com.zs.feature.widget.common.LocalRemote
import com.zs.feature.widget.common.ViewType
import com.zs.feature.widget.common.copy
import com.zs.feature.widget.common.launchApp
...
private fun Compact(
    ...
    Row(
        ...
        CircleIconButton(
            ...
            "",
            onClick = { GlobalScope.launch(Dispatchers.Main) { remote.togglePlay() } },
        ...
        Row(
            ...
            content = {
                ...
                CircleIconButton(
                    SKIP_TO_PREV,
                    "",
                    onClick = { GlobalScope.launch(Dispatchers.Main) { remote.skipToPrevious() } },
                    backgroundColor = null,
                ...
                CircleIconButton(
                    ...
                    "",
                    onClick = { GlobalScope.launch(Dispatchers.Main) { remote.skipToNext() } },
                    backgroundColor = null,
...
private fun Normal(
    ...
    Row(
        ...
        val ctx = LocalContext.current
        CircleIconButton(
            if (state.favourite) ImageProvider(com.zs.core.R.drawable.ic_star) else ImageProvider(com.zs.core.R.drawable.ic_star_border),
            "",
            onClick = {
                GlobalScope.launch(Dispatchers.Main) { remote.toggleLike() }
            },
            backgroundColor = null,
